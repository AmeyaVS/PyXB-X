...
class CodePointSet(object):
    ...
    def __eq__(self, other):
        ...
        return (
            isinstance(other, CodePointSet) and self.__codepoints == other.__codepoints
        )
...
class XML1p0e2(object):
    ...
    Char = CodePointSet(0x0009, 0x000A, 0x000D, (0x0020, 0xD7FF), (0xE000, 0xFFFD))
    ...
    Ideographic = CodePointSet((0x4E00, 0x9FA5), 0x3007, (0x3021, 0x3029)).freeze()
...
MultiCharEsc["W"] = (
    CodePointSet(PropertyMap["P"])
    .extend(PropertyMap["Z"])
    .extend(PropertyMap["C"])
    .freeze()
)
