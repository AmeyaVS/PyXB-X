...
class TestTrac_0094(unittest.TestCase):
    ...
    def testToXML(self):
        ...
        xmlt_options = [
            ...
            % (self.body,),
            six.u(
                """<anything xsi:type="xs:string" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">%s</anything>"""
            )
            % (self.body,),
            six.u(
                """<anything xsi:type="xs:string" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">%s</anything>"""
            )
            % (self.body,),
        ]
