...
class TestTrac0200(unittest.TestCase):
    ...
    def testNil_dateTime(self):
        instance = CreateFromDocument(
            '<xdateTime xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
    ...
    def testNil_date(self):
        instance = CreateFromDocument(
            '<xdate xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
        self.assertTrue(instance._isNil())
    ...
    def testNil_time(self):
        instance = CreateFromDocument(
            '<xtime xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
        self.assertTrue(instance._isNil())
    ...
    def testNil_boolean(self):
        instance = CreateFromDocument(
            '<xboolean xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
        self.assertTrue(instance._isNil())
    ...
    def testNil_duration(self):
        instance = CreateFromDocument(
            '<xduration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
        self.assertTrue(instance._isNil())
