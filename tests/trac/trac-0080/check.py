...
class TestTrac0080(unittest.TestCase):
    ...
    def testType4(self):  # base
        ...
        self.assertRaises(
            pyxb.SimpleTypeValueError,
            self.assignAttribute_,
            i4,
            self._NotANormalizedString,
        )
    ...
    def testType1(self):  # restrict type
        ...
        self.assertRaises(
            pyxb.SimpleTypeValueError, self.assignAttribute_, i1, self._NotAToken
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, self.assignAttribute_, i1, self._NotAnNCName
        )
