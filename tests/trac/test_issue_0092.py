...
class TestIssue0092(unittest.TestCase):
    ...
    def testCreateToDom(self):
        ...
        self.assertEqual(
            templateFragment.toxml(),
            """<?xml version="1.0" ?><TEMPLATE><NODE>1</NODE></TEMPLATE>""",
        )

    def testCreateWithCDATAToDom(self):
        xmlt = (
            "<HOST><ID>1</ID><TEMPLATE><NODE><![CDATA[text]]></NODE></TEMPLATE></HOST>"
        )
        xmld = xmlt.encode("utf-8")
        doc = CreateFromDocument(xmld)
        templateFragment = doc.TEMPLATE.toDOM()
        self.assertEqual(
            templateFragment.toxml(),
            """<?xml version="1.0" ?><TEMPLATE><NODE>text</NODE></TEMPLATE>""",
        )
