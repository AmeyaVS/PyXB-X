...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/xsi-nil.xsd")
)
...
class TestXSIType(unittest.TestCase):
    ...
    def testFull(self):
        xmlt = six.u(
            '<full xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">content</full>'
        )
        ...
        xmlt = six.u(
            '<full xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="false">content</full>'
        )
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "content")
        self.assertFalse(instance._isNil())
        ...
        xmlt = six.u(
            '<full xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true">content</full>'
        )
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "content")
        self.assertFalse(instance._isNil())
    ...
    def testXFull(self):
        xmlt = six.u(
            '<xfull xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">content</xfull>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "content")
    ...
    def testOptional(self):
        xmlt = six.u(
            '<optional xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">content</optional>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "content")
    ...
    def testOptionalNilFalse(self):
        xmlt = six.u(
            '<optional xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="false">content</optional>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "content")
    ...
    def testOptionalNilEETag(self):
        xmlt = six.u(
            '<optional xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
    ...
    def testOptionalNilSETag(self):
        xmlt = six.u(
            '<optional xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"></optional>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "")
    ...
    def testOptionalNilSCETag(self):
        xmlt = six.u(
            '<optional xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"><!-- comment --></optional>'
        )
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        self.assertEqual(instance, "")
    ...
    def testComplexInternal(self):
        xmlt = six.u(
            "<complex><full>full content</full><optional>optional content</optional></complex>"
        )
        ...
        xmlt = six.u(
            '<complex xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><full>full content</full><optional xsi:nil="true"></optional></complex>'
        )
        xmld = xmlt.encode("utf-8")
        doc = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = CreateFromDOM(doc.documentElement)
        ...
        if sys.version_info[1] < 8:
            xmlt = six.u(
                '<complex xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
            )
        else:
            xmlt = six.u(
                '<complex xsi:nil="true" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>'
            )
        xmld = xmlt.encode("utf-8")
        instance._setIsNil()
        self.assertEqual(instance.toDOM().documentElement.toxml("utf-8"), xmld)
    ...
    def testComplex(self):
        ...
        for xmlt in (
            ...
            self.assertTrue(instance._isNil())
            self.assertEqual(
                instance.toDOM().documentElement.toxml("utf-8"), canonicald
            )
            instance.validateBinding()
