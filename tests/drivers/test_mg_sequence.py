...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/test-mg-sequence.xsd")
)
...
class TestMGSeq(unittest.TestCase):
    ...
    def testBad(self):
        ...
        self.assertRaises(
            UnrecognizedContentError, wrapper.createFromDOM, dom.documentElement
        )

    def testBasics(self):
        xmlt = six.u(
            '<ns1:wrapper xmlns:ns1="URN:test-mg-sequence"><first/><second_opt/><third/><fourth_0_2/></ns1:wrapper>'
        )
        ...
        self.assertTrue(
            isinstance(
                instance.first,
                sequence._ElementMap["first"].elementBinding().typeDefinition(),
            )
        )
        self.assertTrue(
            isinstance(
                instance.second_opt,
                sequence._ElementMap["second_opt"].elementBinding().typeDefinition(),
            )
        )
        self.assertTrue(
            isinstance(
                instance.third,
                sequence._ElementMap["third"].elementBinding().typeDefinition(),
            )
        )
        self.assertTrue(
            isinstance(instance.fourth_0_2, collections.abc.MutableSequence)
        )
        self.assertEqual(1, len(instance.fourth_0_2))
        self.assertTrue(
            isinstance(
                instance.fourth_0_2[0],
                sequence._ElementMap["fourth_0_2"].elementBinding().typeDefinition(),
            )
        )
    ...
    def testMultiplesAtEnd(self):
        xmlt = six.u(
            '<ns1:wrapper xmlns:ns1="URN:test-mg-sequence"><first/><third/><fourth_0_2/><fourth_0_2/></ns1:wrapper>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = wrapper.createFromDOM(dom.documentElement)
    ...
    def testMultiplesInMiddle(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"><first/><second_multi/><second_multi/><third/></ns1:altwrapper>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        ...
        self.assertTrue(
            isinstance(
                instance.third,
                altsequence._ElementMap["third"].elementBinding().typeDefinition(),
            )
        )
        self.assertEqual(ToDOM(instance).toxml("utf-8"), xmld)
    ...
    def testMultiplesAtStart(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"><first/><first/><third/></ns1:altwrapper>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = altwrapper.createFromDOM(dom.documentElement)
        ...
        instance = altwrapper(
            first=[
                altsequence._ElementMap["first"].elementBinding()(),
                altsequence._ElementMap["first"].elementBinding()(),
            ],
            third=altsequence._ElementMap["third"].elementBinding()(),
        )
        self.assertEqual(ToDOM(instance).toxml("utf-8"), xmld)

    def testMissingInMiddle(self):
        xmlt = six.u(
            '<ns1:wrapper xmlns:ns1="URN:test-mg-sequence"><first/><third/></ns1:wrapper>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = wrapper.createFromDOM(dom.documentElement)
    ...
    def testMissingAtStart(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"><third/></ns1:altwrapper>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, altwrapper.createFromDOM, dom.documentElement
        )
    ...
    def testMissingAtEndLeadingContent(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"><first/></ns1:altwrapper>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, altwrapper.createFromDOM, dom.documentElement
        )

    def testMissingAtEndNoContent(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"></ns1:altwrapper>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, altwrapper.createFromDOM, dom.documentElement
    ...
    def testTooManyAtEnd(self):
        xmlt = six.u(
            '<ns1:wrapper xmlns:ns1="URN:test-mg-sequence"><first/><third/><fourth_0_2/><fourth_0_2/><fourth_0_2/></ns1:wrapper>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, wrapper.createFromDOM, dom.documentElement
    ...
    def testTooManyAtStart(self):
        xmlt = six.u(
            '<ns1:altwrapper xmlns:ns1="URN:test-mg-sequence"><first/><first/><first/><third/></ns1:altwrapper>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, altwrapper.createFromDOM, dom.documentElement
