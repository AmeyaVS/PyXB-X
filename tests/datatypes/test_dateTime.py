...
class Test_dateTime(unittest.TestCase):
    ...
    def testBad(self):
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.dateTime, "2002-10-27 12:14:32  "
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.dateTime, "2002-10-27 12:14:32.Z"
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.dateTime, "2002-10-27 12:14:32.123405:00"
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.dateTime, "2002-10-27 12:14:32.1234+05"
        )

    def testFromText(self):
        self.verifyTime(
            xsd.dateTime("  2002-10-27T12:14:32", _from_xml=True),
            with_usec=False,
            with_tzinfo=False,
        )
        self.verifyTime(
        ...
        self.verifyTime(
            xsd.dateTime("2002-10-27T12:14:32"), with_usec=False, with_tzinfo=False
        )
        ...
        self.verifyTime(
            xsd.dateTime("2002-10-27T12:14:32.1234+05:00"), with_adj=(-5, 0)
        )
        self.verifyTime(xsd.dateTime("2002-10-27T12:14:32.1234Z"))
    ...
    def testYear(self):
        ...
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.dateTime, "-0024-01-01T00:00:00"
        )
    ...
    def testXsdLiteral(self):
        ...
        self.assertEqual(
            "2002-10-27T07:14:32Z",
            xsd.dateTime("2002-10-27T12:14:32+05:00").xsdLiteral(),
        )
        self.assertEqual(
            "2002-10-27T17:14:32Z",
            xsd.dateTime("2002-10-27T12:14:32-05:00").xsdLiteral(),
        )
        self.assertEqual(
            "2002-10-27T17:14:32.1234Z",
            xsd.dateTime("2002-10-27T12:14:32.123400-05:00").xsdLiteral(),
        )
        # No zone info
    ...
    def testNormalize(self):
        ...
        pdt = datetime.datetime(
            year=2000, month=3, day=4, hour=23, tzinfo=UTCOffsetTimeZone(180)
        )
